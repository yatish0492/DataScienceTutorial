'''
  Logistic Regression works based on 'ln(p/(1-p) = b0+x*b1' formula. Please refer to 'OneNote' application notes under 'ML'page for 
  more details.
'''
...
dataset = pd.read_csv('/Users/ycs/PycharmProjects/DataScieneTutorial/Data/3_2_Logistic_Regression.csv')
...
# ******************************************************************************************************************
# The line drawn between buying and non byuing customers is the 0.5 probability line drawn as explained in 'OneNote' 
#   application notes under 'ML'page
# ******************************************************************************************************************
